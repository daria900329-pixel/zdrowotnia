    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pb-24 lg:pb-0">
          ...
          <div className="grid lg:grid-cols-2 items-center">
            ...
            >
              ...
              <h1 className="font-serif text-[2.6rem] leading-[1.04] sm:text-6xl lg:text-7xl text-foreground mb-8 break-words">
                {t("Żywa.")}
                <span className="block">{t("Kwaśna.")}</span>
                <span className="block text-primary">{t("Naturalnie inna.")}</span>
              </h1>
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-xl mb-8">
                {t("Fermentowany napar herbaciany o charakterystycznym, orzeźwiającym smaku.")}
              </p>
              <p className="text-[0.7rem] sm:text-xs tracking-[0.2em] uppercase text-foreground/70 mb-10">
                {t("herbata")} <span className="text-primary">·</span> fermentacja{" "}
                <span className="text-primary">·</span> {t("czas")}
              </p>
            ...
            <div className="order-1 lg:order-2">
              <img
                src={img(heroImage, "10uiomw1l8oec8")}
        ...
        <section className="py-24 md:py-40 px-6 md:px-10 lg:px-16">
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 md:gap-24 items-center">
            ...
            <ScrollReveal delay={120}>
              <h2 className="font-serif text-4xl sm:text-5xl lg:text-6xl leading-[1.08] text-foreground mb-10">
                {t("Najpierw słyszysz.")}
                <span className="block text-primary">{t("Potem próbujesz.")}</span>
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed max-w-md">
                {t("Ciche syknięcie przy otwarciu.")}
                <br />
                {t("Delikatne musowanie.")}
                <br />
                {t("Kwaśny, herbaciany aromat.")}
                <br />
                {t("I smak, który trudno pomylić z czymkolwiek innym.")}
              </p>
            </ScrollReveal>
          </div>
          ...
          <ScrollReveal delay={200}>
            <p className="font-serif text-3xl sm:text-5xl lg:text-6xl text-center text-foreground/90 max-w-4xl mx-auto mt-24 md:mt-40 leading-[1.15]">
              {t("Kombucha nie próbuje smakować jak oranżada.")}
            </p>
          </ScrollReveal>
        </section>
        ...
        <section className="py-24 md:py-32 bg-secondary/30">
          <div className="max-w-4xl mx-auto px-6 md:px-10 text-center">
            <ScrollReveal>
              <Eyebrow>{t("Krótko")}</Eyebrow>
              <h2 className="font-serif text-4xl sm:text-5xl lg:text-6xl text-foreground leading-[1.1] mb-10">
                {t("Kombucha?")}
                <span className="block text-primary">
                  {t("To po prostu herbata, której daliśmy czas.")}
                </span>
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                {t("Powstaje z naparu herbacianego, cukru i kultury mikroorganizmów uczestniczących w fermentacji.")}
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                {t("Podczas procesu część cukrów zostaje wykorzystana przez mikroorganizmy, a smak napoju stopniowo się zmienia: ze słodkiego w kwaśny, złożony i lekko musujący.")}
              </p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={200}>
              <img
                src={img(teaLeaves, "tevr7l7lnl8z")}
          ...
          <div className="max-w-3xl mx-auto">
            <ScrollReveal>
              <h2 className="font-serif text-4xl sm:text-5xl text-foreground leading-[1.1] mb-4">
                {t("Tak. Do kombuchy dodaje się cukier.")}
              </h2>
              <p className="font-serif text-2xl sm:text-3xl text-primary mb-10">
                {t("Bo bez niego nie byłoby fermentacji.")}
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                {t("Cukier jest substratem wykorzystywanym podczas procesu fermentacji. Nie twierdzimy, że po fermentacji znika w całości — takie deklaracje wymagałyby analizy laboratoryjnej gotowego napoju.")}
              </p>
            </ScrollReveal>
            <ScrollReveal delay={150}>
              <p className="font-serif text-3xl sm:text-4xl lg:text-5xl text-foreground mt-16 leading-[1.15]">
                {t("Fermentacja zmienia napój.")}
                <span className="block text-muted-foreground">{t("Nie działa za pomocą magii.")}</span>
              </p>
            </ScrollReveal>
          </div>
        </section>
        ...
        <section className="relative">
          <img
            src={img(backlight, "18t8hy412gpupu")}
          ...
          <div className="absolute inset-0 flex items-center">
            <div className="px-6 md:px-10 lg:px-16 max-w-3xl">
              <h2 className="font-serif text-3xl sm:text-5xl lg:text-6xl text-background leading-[1.1] mb-8">
                {t("Naturalna fermentacja")}
                <span className="block">{t("nie produkuje identycznych butelek.")}</span>
              </h2>
              <p className="text-background/85 text-lg leading-relaxed">
                {t("Jedna partia może być odrobinę bardziej kwaśna. Inna nieco łagodniejsza. Jedna mocniej musująca.")}
              </p>
              <p className="font-handwritten text-2xl sm:text-3xl text-background mt-8">
                {t("I właśnie to lubimy.")}
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 md:py-36 px-6 md:px-10 lg:px-16">
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
            <ScrollReveal>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                {t("Dwutlenek węgla może powstawać naturalnie podczas fermentacji. Dlatego kombucha może mieć delikatne, naturalne musowanie.")}
              </p>
              <p className="font-serif text-2xl sm:text-3xl text-foreground leading-snug">
                {t("Bąbelki są częścią procesu, a nie efektem robienia „napoju gazowanego”.")}
              </p>
            </ScrollReveal>
            <ScrollReveal delay={120}>
              <img
                src={img(bubbles, "tm7wkh1ov0red")}
          ...
          <div className="max-w-5xl mx-auto text-center">
            <ScrollReveal>
              <h2 className="font-serif text-4xl sm:text-5xl lg:text-6xl text-foreground leading-[1.1] mb-16">
                {t("Nie pytaj, czy jest słodka.")}
                <span className="block text-primary">{t("Zapytaj, jak bardzo jest kwaśna.")}</span>
              </h2>
            </ScrollReveal>
            <ScrollReveal delay={120}>
            ...
            <ScrollReveal delay={180}>
              <img
                src={img(tasteShot, "1hzvvoq1px4brw")}
        ...
        <section className="py-24 md:py-36 px-6 md:px-10 lg:px-16">
          <div className="max-w-5xl mx-auto">
            <ScrollReveal>
              <Eyebrow>{t("Dla kogo")}</Eyebrow>
              <h2 className="font-serif text-4xl sm:text-5xl text-foreground mb-8">
                {t("Dla kogo jest kombucha?")}
              </h2>
              <p className="font-serif text-2xl sm:text-3xl text-primary mb-16">
                {t("Dla ludzi, którzy lubią, kiedy napój ma charakter.")}
              </p>
            </ScrollReveal>
          ...
          <div className="max-w-3xl mx-auto">
            <ScrollReveal>
              ...
              <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl text-foreground leading-[1.15] mb-10">
                {t("Fermentowane nie znaczy „leczy wszystko”.")}
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                {t("Kombucha jest fermentowanym napojem herbacianym. Badania naukowe dotyczą m.in. jej składu chemicznego, produktów fermentacji, związków pochodzących z herbaty oraz mikroorganizmów obecnych w niektórych rodzajach kombuchy.")}
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                {t("Jednocześnie ilość i rodzaj mikroorganizmów oraz skład gotowego napoju mogą różnić się w zależności od:")}
              </p>
              ...
              <p className="text-sm text-muted-foreground/80 italic mt-10">
                {t("Dlatego nie obiecujemy efektów zdrowotnych. Mówimy o smaku i o procesie.")}
              </p>
            </ScrollReveal>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal>
              <h2 className="font-serif text-4xl sm:text-5xl text-foreground leading-[1.1] mb-8">
                {t("Nie standaryzujemy natury")}
                <span className="block text-primary">{t("do ostatniego bąbelka.")}</span>
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                {t("Fermentacja zależy od czasu i warunków. Dlatego drobne różnice między partiami są czymś naturalnym.")}
              </p>
            </ScrollReveal>
            <ScrollReveal delay={120}>
              <img
                src={img(bottles, "ddwiw1flor8h")}
          ...
          <div className="absolute inset-0 flex items-center justify-center text-center px-6">
            <div>
              <h2 className="font-serif text-4xl sm:text-6xl lg:text-7xl text-background leading-[1.05]">
                {t("Schłódź.")}
                <span className="block">{t("Otwórz.")}</span>
                <span className="block">{t("Posłuchaj.")}</span>
                <span className="block">{t("Nalej.")}</span>
              </h2>
              <p className="text-background/85 text-lg mt-8 max-w-md mx-auto">
                {t("Kombucha najlepiej pokazuje swój charakter dobrze schłodzona.")}
              </p>
              <button
                onClick={scrollToBuy}
        ...
        <section className="py-24 md:py-36 bg-secondary/30 px-6 md:px-10 lg:px-16">
          <div className="max-w-7xl mx-auto">
            <ScrollReveal>
              <h2 className="font-serif text-4xl sm:text-5xl lg:text-6xl text-foreground leading-[1.1] mb-16">
                {t("Herbata.")}
                <span className="block">{t("Fermentacja.")}</span>
                <span className="block text-primary">{t("Czas.")}</span>
              </h2>
            </ScrollReveal>
          ...
          <div className="max-w-3xl mx-auto text-center">
            <ScrollReveal>
              <h2 className="font-serif text-4xl sm:text-6xl text-foreground mb-12">
                {t("Nie poganiamy fermentacji.")}
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                {t("Nie wszystko staje się lepsze, kiedy robi się szybciej.")}
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                {t("Kombucha potrzebuje czasu, żeby przestać być po prostu słodką herbatą i nabrać własnego charakteru.")}
              </p>
              <p className="font-serif text-3xl sm:text-5xl text-primary mt-16">
                {t("Dajemy jej ten czas.")}
              </p>
            </ScrollReveal>
          </div>
        </section>
          ...
          <div className="max-w-5xl mx-auto">
              ...
              <ScrollReveal>
                <div className="bg-background p-10 h-full">
                  ...
                  <p className="font-serif text-2xl text-foreground/80 leading-snug">
                    {t("Smak komponowany od początku do końca.")}
                  </p>
                </div>
              </ScrollReveal>
              <ScrollReveal delay={100}>
                <div className="bg-background p-10 h-full">
                  ...
                  <p className="font-serif text-2xl text-foreground leading-snug">
                    {t("Smak zmieniający się podczas fermentacji.")}
                  </p>
                </div>
              </ScrollReveal>
            </div>
            <ScrollReveal delay={150}>
              <p className="font-handwritten text-2xl sm:text-3xl text-center text-foreground/80 mt-12">
                {t("Tu proces jest częścią smaku.")}
              </p>
            </ScrollReveal>
          </div>
        </section>
          ...
          <div className="max-w-5xl mx-auto space-y-16">
              ...
              <div className="grid md:grid-cols-2 gap-12 items-start">
                <div>
                  <h2 className="font-serif text-3xl sm:text-4xl text-foreground mb-6">
                    {t("Coś pojawiło się w butelce?")}
                  </h2>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    {t("W naturalnie fermentowanym napoju może pojawić się osad albo drobne struktury związane z procesem fermentacji. Nie musi to oznaczać wady produktu.")}
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    {t(". Sprawdzimy to razem.")}
                  </p>
                </div>
                <img
                  src={img(backlight, "q17icc1sc0e6u")}
            ...
            <ScrollReveal delay={100}>
              <div className="border border-primary/40 bg-secondary/40 p-10 md:p-14">
                ...
                <p className="font-serif text-3xl sm:text-4xl text-foreground mb-6">
                  {t("Otwieraj dobrze schłodzoną.")}
                </p>
                <p className="text-muted-foreground leading-relaxed max-w-2xl">
                  {t("Naturalna fermentacja może powodować wzrost ciśnienia w butelce. Otwieraj powoli i ostrożnie — to część rytuału, nie ostrzeżenie drobnym drukiem.")}
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={150}>
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <img
                  src={img(stepChill, "q17icc1sc0e6u")}
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    {t("Kombucha jest niepasteryzowana, więc przechowuj ją w lodówce i pij dobrze schłodzoną. Trzymaj z dala od światła i ciepła — w cieple fermentacja przyspiesza, a napój staje się bardziej kwaśny i mocniej musujący.")}
                  </p>
                  <p className="text-sm text-muted-foreground/80 italic">
                    {t("Dokładną datę przydatności znajdziesz na butelce, którą do Ciebie wysyłamy.")}
                  </p>
                </div>
              </div>
            </ScrollReveal>
        ...
        <section className="relative">
          <img
            src={img(finalShot, "10qr14b11a83gx")}
          ...
          <div className="absolute inset-0 flex items-center">
            <div className="px-6 md:px-10 lg:px-16 max-w-2xl">
              <h2 className="font-serif text-4xl sm:text-6xl text-background leading-[1.05] mb-8">
                {t("Ciekawi Cię,")}
                <span className="block">{t("jak smakuje?")}</span>
              </h2>
              <p className="text-background/85 text-lg mb-10">
                {t("Najlepszy sposób, żeby się przekonać, jest bardzo prosty.")}
              </p>
              <button
                onClick={scrollToBuy}
              ...
              <p className="font-handwritten text-2xl text-background/90 mt-10">
                {t("Zdrowotnia — naturalnie dla Ciebie.")}
              </p>
            </div>
          </div>
        </section>
      ...
      <div className="lg:hidden fixed bottom-0 inset-x-0 z-40 bg-background/95 backdrop-blur border-t border-border px-5 py-3 flex items-center justify-between gap-4">
        <div className="min-w-0">
          <p className="text-xs tracking-[0.15em] uppercase text-foreground truncate">{t("Kombucha")}</p>
          {lowestPrice !== null && (
