        ...
        <div className="px-6 md:px-10 lg:px-16 py-20 lg:py-36 order-2 lg:order-1">
          <ScrollReveal>
            ...
            <h2 className="font-serif text-[2.1rem] leading-[1.08] sm:text-5xl lg:text-[3.4rem] text-foreground mb-10 max-w-xl break-words">
              Nie produkujemy wszystkiego.
              <span className="block text-primary">Produkujemy to, co sami chcemy jeść.</span>
            </h2>
            <p className="text-muted-foreground leading-relaxed max-w-lg mb-10">
              Bez kombinowania. Bez anonimowego pochodzenia. Z troską o to, czym karmimy zwierzęta
              i z czego powstaje nasze jedzenie.
            </p>
            ...
            <p className="text-[0.72rem] sm:text-sm tracking-[0.22em] uppercase text-foreground/80 leading-relaxed">
              Małe partie <span className="text-primary">·</span> rodzinny chów{" "}
              <span className="text-primary">·</span> prawdziwe składniki
            </p>
          </ScrollReveal>
        </div>
