...
const TEMPLATE_PRESETS: { key: string; label: string; description: string; variables: string[]; defaultBlocks: EmailBlock[] }[] = [
  ...
  },
  {
    ...
    description: "Ręcznie wysyłany gdy zamówienie jest spakowane",
    variables: ["{{customer_email}}", "{{order_id}}", "{{order_id_short}}"],
    defaultBlocks: [
      { id: "h1", type: "header", content: "Zamówienie gotowe! 📦", styles: { fontSize: "26", color: "#3d2e22", fontWeight: "bold", textAlign: "center", fontFamily: "Georgia, serif" } },
      { id: "d1", type: "divider", content: "", styles: { color: "#e8e0d8", height: "1" } },
      { id: "t1", type: "text", content: "Twoje zamówienie {{order_id_short}} zostało spakowane i czeka na kuriera.", styles: { fontSize: "15", color: "#5c4a3a", textAlign: "left", fontFamily: "Arial, sans-serif" } },
      { id: "t2", type: "text", content: "Gdy paczka zostanie wysłana, otrzymasz osobną wiadomość z numerem śledzenia.", styles: { fontSize: "15", color: "#5c4a3a", textAlign: "left", fontFamily: "Arial, sans-serif" } },
      { id: "s1", type: "spacer", content: "", styles: { height: "16" } },
      { id: "t3", type: "text", content: "Pozdrawiamy,\nZespół Zdrowotnia 🌱", styles: { fontSize: "14", color: "#7a6b5d", textAlign: "center", fontFamily: "Arial, sans-serif" } },
    ],
  },
  {
    key: "shipping_notification",
    label: "Zamówienie wysłane",
    description: "Wysyłany gdy paczka została nadana",
    variables: ["{{customer_email}}", "{{order_id}}", "{{order_id_short}}", "{{tracking_url}}"],
    defaultBlocks: [
      { id: "h1", type: "header", content: "Paczka w drodze! 🚚", styles: { fontSize: "26", color: "#3d2e22", fontWeight: "bold", textAlign: "center", fontFamily: "Georgia, serif" } },
      { id: "d1", type: "divider", content: "", styles: { color: "#e8e0d8", height: "1" } },
      { id: "t1", type: "text", content: "Zamówienie {{order_id_short}} zostało wysłane!", styles: { fontSize: "15", color: "#5c4a3a", textAlign: "left", fontFamily: "Arial, sans-serif" } },
  ...
  {
    key: "promotion",
    label: "Akcja promocyjna",
    description: "Szablon do wysyłania promocji",
    variables: ["{{customer_email}}", "{{promo_title}}", "{{promo_description}}", "{{promo_code}}", "{{promo_discount}}", "{{promo_url}}", "{{promo_expiry}}"],
    defaultBlocks: [
      { id: "h1", type: "header", content: "{{promo_title}}", styles: { fontSize: "28", color: "#3d2e22", fontWeight: "bold", textAlign: "center", fontFamily: "Georgia, serif" } },
      { id: "t1", type: "text", content: "{{promo_description}}", styles: { fontSize: "16", color: "#5c4a3a", textAlign: "center", fontFamily: "Arial, sans-serif" } },
      { id: "t2", type: "text", content: "Kod rabatowy: {{promo_code}} — {{promo_discount}}", styles: { fontSize: "20", color: "#c78b2d", textAlign: "center", fontFamily: "Georgia, serif" } },
      { id: "b1", type: "button", content: "Skorzystaj z oferty →", styles: { backgroundColor: "#c78b2d", color: "#ffffff", fontSize: "17", borderRadius: "8", padding: "14", textAlign: "center", href: "{{promo_url}}" } },
      { id: "t3", type: "text", content: "Oferta ważna do: {{promo_expiry}}", styles: { fontSize: "13", color: "#7a6b5d", textAlign: "center", fontFamily: "Arial, sans-serif" } },
    ],
  },
  {
    key: "custom",
